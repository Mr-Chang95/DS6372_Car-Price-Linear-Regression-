...
#Lasso
model4.fit2 <-train(log(selling_price)~year + log(km_driven) + fuel+ seller_type + transmission + owner + mileage + log(engine) + log(max_power) + log(seats) + brand, data= car_details,
                  method="glmnet",
                  trControl=fitControl,
